      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold mb-4 text-primary/90">Who am I?</h3>
            <p className="text-muted-foreground mb-6">
              I&apos;m a Computer Science student at SVNIT Surat with a passion for backend development and
              problem-solving. I have experience working with various technologies and frameworks, and I enjoy building
              robust and scalable applications.
            </p>
            <p className="text-muted-foreground mb-6">
              Currently, I&apos;m working as a Backend Developer Intern at WhatBytes, where I develop APIs, build
              backend systems, and enhance AI models. I&apos;ve also interned at Bhabha Atomic Research Centre (BARC),
              where I optimized databases and developed a troubleshooting chatbot.
            </p>

            <div className="mt-8">
              <h3 className="text-xl font-bold mb-4 text-primary/90">Education</h3>
